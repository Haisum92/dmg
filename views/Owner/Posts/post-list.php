<?php $this->load->view('Owner/Posts/header');?>
<!--
		===========================================================
		BEGIN PAGE
		===========================================================
		...
		<div class="wrapper">
			...
			<div class="page-content no-left-sidebar">
				...
				<!-- Begin page heading -->
					<h1 class="page-heading">Post(s) Managment <!-- <small>Sub heading here</small> --></h1>
					<!-- End page heading -->
				
					<!-- Begin breadcrumb -->
					<ol class="breadcrumb default square rsaquo sm">
						<li><a href="<?php echo base_url();?>"><i class="fa fa-home"></i></a></li>
						<li><a href="<?php echo base_url('owner/posts.all');?>">Post(s)</a></li>
									...
									<tbody>
										...
										{?>
											<tr class="<?php if($key %2 == 0){ ?>even <?php } else{?> odd <?php } ?>">
												...
												<td><?php echo ucfirst($post->area_title);?></td>
												<td><?php echo ucfirst($post->branch_title);?></td>
												<td><?php echo $post->add_by;?></td>
												<td><?php echo ucfirst($post->status);?></td>
												<td><?php echo $post->date_added;?></td>
												<td>
													<button class="btn btn-info btn-perspective" onclick="window.location.href='post.view/<?php echo $post->p_id;?>';">View</button>
...
<?php $this->load->view('Owner/Posts/footer');?>