...
<!--
		...
		<div class="wrapper">
			...
			<div class="page-content no-left-sidebar">
				...
				<!-- Begin page heading -->
					<h1 class="page-heading">Post Managment <!-- <small>Sub heading here</small> --></h1>
					<!-- End page heading -->
				
					<!-- Begin breadcrumb -->
					<ol class="breadcrumb default square rsaquo sm">
						<li><a href="<?php echo base_url();?>"><i class="fa fa-home"></i></a></li>
						<li><a href="<?php echo base_url('owner/posts.all');?>">Posts</a></li>
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="the-box">
								<h4 class="small-title">Register Post</h4>
								...
								<form id="add_post_form" method="post" name="post_registration_form" class="form-horizontal" enctype= "multipart/form-data" action="register.post">
									...
									<div class="form-group">
										<div class="col-lg-9 col-lg-offset-3">
											<button type="submit" name="register_post" class="btn btn-info">Submit</button>
										</div>
									</div>
								</form>
							</div><!-- /.the-box -->
