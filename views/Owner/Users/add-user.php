								...
								<li class="dropdown">
									...
									<ul class="dropdown-menu square margin-list-rounded with-triangle">
										<li>
											...
											<button class="btn btn-info btn-square btn-block">See all message</button>
										</li>
									</ul>
								</li>
								<!-- End nav message -->
								...
								<li class="dropdown">
									...
									<ul class="dropdown-menu square margin-list-rounded with-triangle">
										<li>
											...
											<button class="btn btn-info btn-square btn-block">See all request</button>
										</li>
									</ul>
								</li>
			...
			<div class="page-content no-left-sidebar">
				...
				<!-- Begin page heading -->
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="the-box">
								<h4 class="small-title">Register User</h4>
								...
								<form id="user_registration_form" method="post" name="user_registration_form" class="form-horizontal" action="register.user">
									...
									<div class="form-group">
										...
										<div class="col-lg-5">
											<input class="form-control" name="email" type="email" placeholder="abc@hotmail.com" data-bv-emailaddress-message="The input is not a valid email address" />
										</div>
									</div>
									...
									<div class="form-group">
										<div class="col-lg-9 col-lg-offset-3">
											<button type="submit" name="register_user" class="btn btn-info">Submit</button>
										</div>
									</div>
								</form>
							</div><!-- /.the-box -->
