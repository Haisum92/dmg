			...
			<div class="page-content no-left-sidebar">
				...
				<!-- Begin page heading -->
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="the-box">
								<h4 class="small-title">Edit Menu</h4>
								...
								<form id="add_branch_form" method="post" name="branch_registration_form" class="form-horizontal" action="../menu.edit/<?php echo $menu_data[0]->m_id;?>" >
									...
									<div class="form-group">
										<div class="col-lg-9 col-lg-offset-3">
											<button type="submit" name="edit_menu" class="btn btn-info">Update</button>
											<button type="button" name="cancel_edit_menu" class="btn btn-info" onclick="window.location.href='../menu.all';">Cancel</button>
										</div>
									</div>
								</form>
							</div><!-- /.the-box -->
