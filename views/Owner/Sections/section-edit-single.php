			...
			<div class="page-content no-left-sidebar">
				...
				<!-- Begin page heading -->
					...
					<ol class="breadcrumb default square rsaquo sm">
						...
						<li><a href="<?php echo base_url('owner/section.all');?>">Sections</a></li>
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="the-box">
								<h4 class="small-title">Update Section</h4>
                                ...
                                <?php }?>
								<form id="section_update_form" method="post" name="section_update_form" class="form-horizontal" action="../revise.section/<?php echo $section_data[0]->s_id;?>">
									
									<div class="form-group">
										<label class="col-lg-3 control-label">Title</label>
										<div class="col-lg-5">
											<input type="text" class="form-control" name="title" id="title" placeholder="xxXXxx" value="<?php echo $section_data[0]->title;?>" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-5">
											<select data-placeholder="Choose a status..." class="form-control chosen-select" tabindex="4" name="status">
												<option value="">&nbsp;</option>
												<option value="active" <?php if($section_data[0]->status == 'active'){?> selected <?php }?>>Active</option>
									...
									<div class="form-group">
										<div class="col-lg-9 col-lg-offset-3">
											<button type="submit" name="register_section" class="btn btn-info">Submit</button>
										</div>
									</div>
								</form>
							</div><!-- /.the-box -->
