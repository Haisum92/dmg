			...
			<div class="page-content no-left-sidebar">
				...
				<!-- Begin page heading -->
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="the-box">
								<h4 class="small-title">Register Section</h4>
                                ...
                                <?php }?>
								<form id="add_section_form" method="post" name="section_registration_form" class="form-horizontal" action="register.section"
									...
									<div class="form-group">
										<div class="col-lg-9 col-lg-offset-3">
											<button type="submit" name="register_section" class="btn btn-primary">Register</button>
										</div>
									</div>
								</form>
							</div><!-- /.the-box -->
