			...
			<div class="page-content no-left-sidebar">
				...
				<!-- Begin page heading -->
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="the-box">
								<h4 class="small-title">Register Branch</h4>
								...
								<form id="branch_registration_form" method="post" name="branch_registration_form" class="form-horizontal" action="register.branch">
									...
									<div class="form-group">
										<div class="col-lg-9 col-lg-offset-3">
											<button type="submit" name="register_branch" class="btn btn-info">Register</button>
											<button type="button" name="cancel_branch_add" class="btn btn-info" onclick="window.location.href='branch.all'">Cancel</button>
										</div>
									</div>
								</form>
							</div><!-- /.the-box -->
