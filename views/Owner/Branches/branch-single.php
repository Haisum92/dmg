					...
					<div class="the-box">
                        ...
                        <div class="row">
	                        <div class="col-lg-12">
	                        	<div class="row">
	                        		<div class="col-lg-4">
	                        			<label for="Title">Title</label>: <?php echo $branch_data[0]->title;?>
	                        		</div>
	                        		<div class="col-lg-4">
	                    ...
	                    <div class="row">
	                        <div class="col-lg-12">
	                        	<div class="row">
	                        		<div class="col-lg-4">
	                        			<button class="btn btn-info btn-perspective" onclick="window.location.href='../branch.all';">Back To Branch List</button>
	                        		</div>
	                        	</div>
	                        </div>
	                    </div>
