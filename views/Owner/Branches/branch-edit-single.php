			...
			<div class="page-content no-left-sidebar">
				...
				<!-- Begin page heading -->
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="the-box">
								<h4 class="small-title">Edit Branch</h4>
								...
								<form id="edit_branch_form" method="post" name="edit_branch_form" class="form-horizontal" action="../branch.edit/<?php echo $branch_data[0]->b_id;?>">
									...
									<div class="form-group">
										<div class="col-lg-9 col-lg-offset-3">
											<button type="submit" name="edit_branch" class="btn btn-info">Update</button>
											<button type="button" name="cancel_branch_edit" class="btn btn-info" onclick="window.location.href='../branch.all'">Cancel</button>
										</div>
									</div>
								</form>
							</div><!-- /.the-box -->
