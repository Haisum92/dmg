...
<!--
		...
		<div class="wrapper">
			...
			<div class="page-content no-left-sidebar">
				...
				<!-- Begin page heading -->
					<h1 class="page-heading">Branches Managment <!-- <small>Sub heading here</small> --></h1>
					<!-- End page heading -->
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="the-box">
								<h4 class="small-title">Register Branch Menu</h4>
								...
								<form id="branch_menu_registration" method="post" name="branch_menu_registration" class="form-horizontal" action="../register.branch.menu/<?php echo $branch_data[0]->b_id;?>">
									...
									<div class="form-group">
										...
										<div class="col-lg-5">
											<select data-placeholder="Choose a Section..." class="form-control chosen-select" name="menu[]" id="menu[]" tabindex="2" multiple>
												...
												{
													?>
													<option value="<?php echo $menu->m_id;?>" <?php echo  set_select('menu[]', $menu->m_id, FALSE); ?>><?php echo $menu->title;?></option>
												<?php }?>
											</select>
										</div>
									</div>
									...
									<div class="form-group">
										<div class="col-lg-9 col-lg-offset-3">
											<button type="submit" name="register_branch_menu" class="btn btn-primary">Register</button>
											<button type="button" name="cancel_registering_branch_menu" class="btn btn-primary" onclick="window.location.href='../branch.all'">Cancel</button>
										</div>
									</div>
								</form>
							</div><!-- /.the-box -->
