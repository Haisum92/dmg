								...
								<form id="branch_menu_registration" method="post" name="branch_menu_registration" class="form-horizontal" action="../register.branch.menu/<?php echo $branch_data[0]->b_id;?>">
									...
									<div class="form-group">
										<div class="col-lg-9 col-lg-offset-3">
											<button type="submit" name="register_branch_menu" class="btn btn-info">Register</button>
											<button type="button" name="cancel_registering_branch_menu" class="btn btn-info" onclick="window.location.href='../branch.all'">Cancel</button>
										</div>
									</div>
								</form>
							</div><!-- /.the-box -->
