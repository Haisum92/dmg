...
<!--
		...
		<div class="wrapper">
			...
			<div class="page-content no-left-sidebar">
				...
				<!-- Begin page heading -->
					<h1 class="page-heading">Branch Menus Managment <!-- <small>Sub heading here</small> --></h1>
					<!-- End page heading -->
				
					<!-- Begin breadcrumb -->
					<ol class="breadcrumb default square rsaquo sm">
						<li><a href="<?php echo base_url();?>"><i class="fa fa-home"></i></a></li>
						<li><a href="<?php echo base_url('owner/branch.all');?>">Branch</a></li>
						<li class="active">Branch Menus</li>
					</ol>
					<!-- End breadcrumb -->
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="the-box">
								<h4 class="small-title">Revise Branch Menus</h4>
                                ...
                                <?php }?>
								<form id="add_branch_form" method="post" name="branch_registration_form" class="form-horizontal" action="../revise.branch.menu/<?php echo $branch_data[0]->b_id;?>"
											...
											<select data-placeholder="Choose a Section..." class="form-control chosen-select" name="menu[]" tabindex="2" multiple>
												...
												<?php foreach ($menu_list as $key => $menu) 
												{
													...
													<option value="<?php echo $menu->m_id;?>" 
														<?php if(in_array($menu->m_id,$branch_menu)){?> selected <?php } ?> <?php echo  set_select('menu[]', $menu->m_id, FALSE); ?>
														>
														<?php echo $menu->title;?>
													</option>
												<?php }?>
									...
									<div class="form-group">
										...
										<div class="col-lg-5">
											<select data-placeholder="Choose a status..." class="form-control chosen-select" tabindex="4" name="status">
												<option value="">&nbsp;</option>
												<option value="active" <?php if($branch_data[0]->status == "active"){?> selected <?php } ?> <?php echo set_select('status[]', 'active', FALSE); ?>>Active</option>
												<option value="suspended" <?php if($branch_data[0]->status == "suspended"){?> selected <?php } ?> <?php echo set_select('status[]', 'active', FALSE); ?>>Suspended</option>
											</select>
										</div>
									</div>
									...
									<div class="form-group">
										<div class="col-lg-9 col-lg-offset-3">
											<button type="submit" name="revise_branch_menu" class="btn btn-primary">Update</button>
											<button type="button" name="register_branch_menu" class="btn btn-primary" onclick="window.location.href='../branch.all'">Cancel</button>
										</div>
									</div>
								</form>
							</div><!-- /.the-box -->
				...
				<!-- BEGIN FOOTER -->
				<footer>
					&copy; <?php echo date('Y');?> <a href="<?php echo base_url('owner');?>">Directory Managment</a><br />
