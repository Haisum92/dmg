								...
								<form id="add_branch_form" method="post" name="branch_registration_form" class="form-horizontal" action="../revise.branch.menu/<?php echo $branch_data[0]->b_id;?>"
									...
									<div class="form-group">
										<div class="col-lg-9 col-lg-offset-3">
											<button type="submit" name="revise_branch_menu" class="btn btn-info">Update</button>
											<button type="button" name="register_branch_menu" class="btn btn-info" onclick="window.location.href='../branch.all'">Cancel</button>
										</div>
									</div>
								</form>
							</div><!-- /.the-box -->
