								...
								<form id="add_area_branch_form" method="post" name="area_branch_registration_form" class="form-horizontal" action="../register.area.branch/<?php echo $area_data[0]->a_id;?>">
									...
									<div class="form-group">
										<div class="col-lg-9 col-lg-offset-3">
											<button type="submit" name="register_area_branch" class="btn btn-info">Submit</button>
											<button type="button" name="cancel_registering_area_branch" class="btn btn-info" onclick="window.location.href='../area.all'">Cancel</button>
										</div>
									</div>
								</form>
							</div><!-- /.the-box -->
