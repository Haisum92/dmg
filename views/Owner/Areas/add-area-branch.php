...
<!--
		...
		<div class="wrapper">
			...
			<div class="page-content no-left-sidebar">
				...
				<!-- Begin page heading -->
					<h1 class="page-heading">Area Branch Managment <!-- <small>Sub heading here</small> --></h1>
					<!-- End page heading -->
				
					<!-- Begin breadcrumb -->
					<ol class="breadcrumb default square rsaquo sm">
						<li><a href="<?php echo base_url();?>"><i class="fa fa-home"></i></a></li>
						<li><a href="<?php //echo base_url('owner/branch.all');?>">Area Branches</a></li>
						<li class="active">Add Area Branches</li>
					</ol>
					<!-- End breadcrumb -->
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="the-box">
								<h4 class="small-title">Register Area Branches</h4>
                                ...
                                <?php }?>
								<form id="add_area_branch_form" method="post" name="area_branch_registration_form" class="form-horizontal" action="../register.area.branch/<?php echo $area_data[0]->a_id;?>"
									...
									<div class="form-group">
										<div class="col-lg-9 col-lg-offset-3">
											<button type="submit" name="register_area_branch" class="btn btn-primary">Register</button>
											<button type="button" name="cancel_registering_area_branch" class="btn btn-primary" onclick="window.location.href='../area.all'">Cancel</button>
										</div>
									</div>
								</form>
							</div><!-- /.the-box -->
