...
<!--
		...
		<div class="wrapper">
			...
			<div class="page-content no-left-sidebar">
				...
				<!-- Begin page heading -->
					<h1 class="page-heading">Area Managment <!-- <small>Sub heading here</small> --></h1>
					<!-- End page heading -->
				
					<!-- Begin breadcrumb -->
					<ol class="breadcrumb default square rsaquo sm">
						<li><a href="<?php echo base_url();?>"><i class="fa fa-home"></i></a></li>
						<li><a href="<?php echo base_url('owner/area.all');?>">Areas</a></li>
						<li>All Areas</li>
					</ol>
					<!-- End breadcrumb -->
					...
					<div class="the-box">
                        ...
                        <div class="row">
	                        <div class="col-lg-12">
	                        	<div class="row">
	                        		<div class="col-lg-4">
	                        			<label for="Title">Title</label>: <?php echo $area_data[0]->title;?>
	                        		</div>
	                        		<div class="col-lg-4">
	                        			<label for="Status">Status</label>: <?php echo ucfirst($area_data[0]->status);?>
	                        		</div>
	                        		<div class="col-lg-4">
	                        			<label for="Add By">Add By</label>: <?php echo $area_data[0]->add_by;?>
	                        		</div>
	                        	</div>
	                        </div>
	                    </div>
	                    ...
	                    <div class="row">
	                        <div class="col-lg-12">
	                        	<div class="row">
	                        		<div class="col-lg-4">
	                        			<label for="Added Date">Added Date</label>: <?php echo date("M, d, Y @ g:i:s a", strtotime($area_data[0]->date_added));?>
	                        		</div>
	                        	</div>
	                        </div>
	                    </div>
	                    ...
	                    <div class="row">
	                        <div class="col-lg-12">
	                        	<div class="row">
	                        		<div class="col-lg-4">
	                        			<button class="btn btn-info btn-perspective" onclick="window.location.href='../area.all';">Back To Area List</button>
	                        		</div>
	                        	</div>
	                        </div>
	                    </div>
