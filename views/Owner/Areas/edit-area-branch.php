								...
								<form id="area_branch_form" method="post" name="area_branch_registration_form" class="form-horizontal" action="../revise.area.branch/<?php echo $area_data[0]->a_id;?>"
									...
									<div class="form-group">
										<div class="col-lg-9 col-lg-offset-3">
											<button type="submit" name="register_menu_section" class="btn btn-info">Update</button>
											<button type="button" name="cancel_registering_menu_section" class="btn btn-info" onclick="window.location.href='../area.all'">Cancel</button>
										</div>
									</div>
								</form>
							</div><!-- /.the-box -->
